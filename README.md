...
> **[Decode a Morse code message]** Ruby program to decrypt morse messages
...
- **[Reuse multiple methods in order to decode a complete morse message]**
...
```bash
  git@github.com:dgcuenca/decode-morse-msg.git
```
